...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.log('🤖 Провайдер:', isClaudeModel ? 'Claude' : isGroqModel ? 'Groq' : 'Gemini');
    ...
    if (isClaudeModel) {
      ...
      const prompt = `You are a receipt OCR expert. Extract EVERY line from this receipt.
...
RULES:
1. ALL products with EXACT quantity
2. TAX/VAT as item
3. TOTAL → "total" field
...
{"store_name":"","store_name_ru":"","date":"","time":"","total":0,"subtotal":0,"tax":0,"currency":"${currency}","items":[{"name":"","name_ru":"","quantity":1,"price":0,"total":0}],"payment_method":""}
Include TAX/VAT. Return ONLY JSON.`;
